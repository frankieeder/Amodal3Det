...
def VGG_16_RGB(img):
    ...
    bn_conv4_1 = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv4_1')(conv4_1)
    padding4_2 = ZeroPadding2D((1, 1), name='padding4_2')(bn_conv4_1)
    conv4_2 = Conv2D(512, (3, 3), activation='relu', name='conv4_2')(padding4_2)
    bn_conv4_2 = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv4_2')(conv4_2)
    ...
    bn_conv5_1 = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv5_1')(conv5_1)
    padding5_2 = ZeroPadding2D((1, 1), name='padding5_2')(bn_conv5_1)
    conv5_2 = Conv2D(512, (3, 3), activation='relu', name='conv5_2')(padding5_2)
    bn_conv5_2 = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv5_2')(conv5_2)
    padding5_3 = ZeroPadding2D((1, 1), name='padding5_3')(bn_conv5_2)
    conv5_3 = Conv2D(512, (3, 3), activation='relu', name='conv5_3')(padding5_3)
    bn_conv5_3 = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv5_3')(conv5_3)
...
def VGG_16_D(dmap):
    ...
    bn_conv3_1d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv3_1d')(conv3_1d)
    ...
    bn_conv3_2d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv3_2d')(conv3_2d)
    ...
    bn_conv4_1d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv4_1d')(conv4_1d)
    ...
    bn_conv4_2d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv4_2d')(conv4_2d)
    ...
    bn_conv5_1d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv5_1d')(conv5_1d)
    ...
    bn_conv5_2d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv5_2d')(conv5_2d)
    ...
    bn_conv5_3d = BatchNormalization(epsilon=0, center=True, scale=True, name='bn_conv5_3d')(conv5_3d)
